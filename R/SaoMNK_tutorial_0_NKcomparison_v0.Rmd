---
title: 'SaoMNK Tutorial: Generalizing NK Epistatic Interaction Fitness v0'
author: "S. Downing"
date: "`r Sys.Date()`"
output:
...
structure_model <- list(
  dv_bipartite = list(
    ...
    interactions = list(
      ...
      list(effect='inPopX|egoX',   parameter= 0, dv_name=DV_NAME, fix=T,
           interaction1='self$strat_2_coCovar',
           interaction2='self$strat_1_coCovar'
      )#,
...
structure_model <- list(
  dv_bipartite = list(
    ...
    ##**DYADIC CONSTANT COVARIATE EFFECTS -- EXOGENOUS INTERACTION MATRIX**
    coDyadCovars = list(
      list(effect='XWX',   parameter= .02, dv_name=DV_NAME, fix=T,
           interaction1='self$component_1_coDyadCovar',
           x = component_int_mat ## component-[actor]-component dyads
      ) #,
      # list(effect='X',   parameter= 0, dv_name=DV_NAME, fix=T,
    ...
    varDyadCovars = list(),
    interactions = list(
      list(effect='egoX|XWX',   parameter= -.01, dv_name=DV_NAME, fix=T,
           interaction1='self$strat_1_coCovar',
           interaction2='self$component_1_coDyadCovar'
      ),
      list(effect='inPopX|egoX',   parameter= .1, dv_name=DV_NAME, fix=T,
           interaction1='self$strat_2_coCovar',
           interaction2='self$strat_1_coCovar'
      )#,
      # list(effect='totInDist2|X',   parameter= 0, dv_name=DV_NAME, fix=T,
