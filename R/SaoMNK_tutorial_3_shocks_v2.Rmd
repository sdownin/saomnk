...
theta_shocks_1 <- list(
  list(effect=c('egoX','inPopX'), parameter=c( 0, 0), portion = 3, shock_on=0),
  list(effect=c('egoX','inPopX'), parameter=c( 0, 1), portion = 2, shock_on=1, label='inPopX on'),
  list(effect=c('egoX','inPopX'), parameter=c( 0, 0), portion = 1, shock_on=0),
  list(effect=c('egoX','inPopX'), parameter=c( 1, 0), portion = 2, shock_on=1, label='egoX on'),
  list(effect=c('egoX','inPopX'), parameter=c( 0, 0), portion = 2, shock_on=0)
)
