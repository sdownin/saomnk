...
SAOM_NK_Enhanced <- R6Class(
  ...
  public = list(
    ...
    # RSIENA
    local_search_rsiena_init = function(iterations) {
      ...
      self$siena_effects <- setEffect(self$siena_effects, inPop, 
                                      name = 'self$bipartite_sienaDV', initialValue = .2)  ## effect parameter vs. initial value ?
      # 
      self$siena_effects <- includeEffects(self$siena_effects, 
                                           outAct, 
                                           name = 'self$bipartite_sienaDV')
      ...
      self$siena_effects <- setEffect(self$siena_effects, cycle4, 
                                      name = 'self$bipartite_sienaDV', initialValue = -.3)  ## effect parameter vs. initial value ?
      # #-------------------------------
      # #-------------------------------
      # # bipartite DV interactions with social
      # # self$siena_effects <- includeEffects(self$siena_effects,
      # #                                      sharedTo,
      # #                                      name = 'self$bipartite_sienaDV',
      # #                                      interaction1 = "self$social_sienaDV")
      # # self$siena_effects <- setEffect(self$siena_effects, sharedTo, initialValue = -1.0,
      # #                                 name = 'self$bipartite_sienaDV',
      # #                                 interaction1 = "self$social_sienaDV")  ## effect parameter vs. initial value ?
      # # #
      # # self$siena_effects <- includeEffects(self$siena_effects, 
      # #                                      avDegIntn,
      # #                                      name = 'self$bipartite_sienaDV',
      # #                                      interaction1 = "self$social_sienaDV")
      # # self$siena_effects <- setEffect(self$siena_effects, avDegIntn, initialValue = 0.5, 
      # #                                 name = 'self$bipartite_sienaDV',
      # #                                 interaction1 = "self$social_sienaDV")  ## effect parameter vs. initial value ?
      # ##-----------------------------
      # ##-----------------------------
      ...
      # #                                      name = 'self$social_sienaDV')
      # self$siena_effects <- setEffect(self$siena_effects, density,
      #                                 name = 'self$social_sienaDV', initialValue = -0.1)  ## effect parameter vs. initial value ?
      # ## Social transitivity
      # self$siena_effects <- includeEffects(self$siena_effects,
      #                                      transTriads,
      #                                      name = 'self$social_sienaDV')
      # self$siena_effects <- setEffect(self$siena_effects, transTriads,
      #                                 name = 'self$social_sienaDV', initialValue = 0.3)  ## effect parameter vs. initial value ?
      # 
      # ##
      # ##-----------------------------
      ...
      # #                                      name = 'self$search_sienaDV')
      # self$siena_effects <- setEffect(self$siena_effects, density,
      #                                 name = 'self$search_sienaDV', initialValue = 0.2)  ## effect parameter vs. initial value ?
      # ##-----------------------------
      # ##-----------------------------
      ...
      print(summary(self$siena_model))
      # plot(self$siena_model)
      
      print(screenreg(list(saom_nk_enhanced$siena_model), single.row = T, digits = 3))
      
      
      ## 
      # updated_bipartite_network <- self$siena_model$sims[[length(self$siena_model$sims)]]
      # self$set_system_from_bipartite_network(updated_bipartite_network)
    ...
    ##**TODO** FIX Batch iterations update 
    local_search_rsiena_batchrun = function(batches=10, batch_iter=10) {
      for (i in 1:batches) {
        if (is.null(self$siena_model)) {
          self$local_search_rsiena_init(iterations = batch_iter)
        } else {
          self$local_search_rsiena_extend(iterations = batch_iter)
        }
      }
    },
    ...
    objective_func = function(actor_id, component_id) {
      ...
      social_igraph <- self$get_social_igraph()
      ...
      component_igraph <- self$get_component_igraph()
...
#     +     x
#     + }
# > simusnas <- lapply(saom_nk_enhanced$siena_model$sims, make.edgelist.sna, 50)
...
saom_nk_enhanced <- SAOM_NK_Enhanced$new(M = 15, N = 20, BI_PROB = .15, sim_name = '_TEST_')
# saom_nk_enhanced$local_search_rsiena(1)
saom_nk_enhanced$local_search_rsiena_batchrun(batches=3, batch_iter=500) 
