...
SAOM_NK_Enhanced <- R6Class(
  ...
  ##
    ...
    local_search_rsiena_init = function(iterations) {
      ...
      #                                      name = 'self$social_sienaDV')
      self$siena_effects <- setEffect(self$siena_effects, density,
                                      name = 'self$social_sienaDV', initialValue = -0.1, fix = T)  ## effect parameter vs. initial value ?
      ## Social transitivity
      self$siena_effects <- includeEffects(self$siena_effects,
                                           transTriads,
                                           name = 'self$social_sienaDV')
      ...
      #                                      name = 'self$search_sienaDV')
      self$siena_effects <- setEffect(self$siena_effects, density,
                                      name = 'self$search_sienaDV', initialValue = 0.2, fix = T)  ## effect parameter vs. initial value ?
      ##-----------------------------
      ##-----------------------------
    ...
    local_search_rsiena_batchrun = function(batches=10, batch_iter=100) {
      for (i in 1:batches) {
...
saom_nk_enhanced <- SAOM_NK_Enhanced$new(M = 15, N = 12, BI_PROB = .15, sim_name = '_TEST_')
# saom_nk_enhanced$local_search_rsiena(1)
saom_nk_enhanced$local_search_rsiena_batchrun(batches=1, batch_iter=300) 
