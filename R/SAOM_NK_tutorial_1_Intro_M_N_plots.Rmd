---
title: 'SaoMNK Tutorial 1: Endogenizing the Strategic Search Landscape'
author: "S. Downing"
date: "`r Sys.Date()`"
output:
...
network can be then be analyzed according to the Stochastic Actor-Oriented (SAOM) 
...
## load in this excluded chunk to avoid the verbose output of loading dependecies in the SaoMNK class 
