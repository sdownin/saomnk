...
##****************************************************##
## INPUT FILE
grid.input.file <- 'SAOMNK_gridsearch_input_start0_M9.xlsx'
## ITERATIONS
ITERATIONS <- 6000
##****************************************************##
...
## save grid dimensions before run
write.csv(dim(paramgrid), file = file.path(dir_job, 'paramgrid_dimensions.csv'), row.names = F )
...
for (i in 1:nrow(paramgrid)) {
  ...
  ##****************************************##
  ## II. SIM ANALYSIS:  Init, Run, Process Stats
  ##****************************************##
  ## INIT Environment 
